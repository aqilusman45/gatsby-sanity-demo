...
export const ServicesSection = ({
  ...
  const servicesSectionClasses = clsx(otherClasses,"bg-secondary_gray_300 pt-section_py_mob pb-[45px]  lg:py-section_py_desk");
...
fragment ServicesSection on SanityServicesSectionReference {
  __typename
  identifier
  heading
}`
